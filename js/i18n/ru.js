export const ru = Object.freeze({
  ...
  slaEditor: {
    serviceId: 'Идентификатор услуги (необязательно)', create: 'Создать правило', edit: 'Редактировать правило',
    title: 'Название', order: 'Порядок', times: 'Реакция / решение', enabled: 'Включено', actions: 'Действия',
    enable: 'Включить', disable: 'Отключить', delete: 'Удалить', deleteConfirm: 'Удалить правило SLA?',
    reaction: 'Реакция, рабочих минут', resolution: 'Решение, рабочих минут', calendar: 'Рабочий календарь',
    conditions: 'Условия', addCondition: 'Добавить условие', paused: 'Приостанавливающие статусы',
    test: 'Проверка контекста', runTest: 'Проверить на сервере', checkConflicts: 'Проверить пересечения',
    serverResult: 'Результат сервера', preview: 'Предпросмотр браузера',
    approximateWarning: 'Предупреждение: проверка пересечений приблизительная', noWarnings: 'Предварительных конфликтов не найдено.',
    empty: 'Правила SLA не найдены.', loadError: 'Не удалось загрузить правила SLA.', saved: 'Изменения SLA сохранены.',
    commandError: 'Не удалось выполнить операцию SLA.', versionConflict: 'Правила уже изменены другим пользователем. Перезагрузите список.'
  },
  profile: {
