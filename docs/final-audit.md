...
Дата проверки: 2026-08-06. Объект: статический ITSM-прототип, этапы 1–16; документация
актуализирована на этапе 17.
...
## Комплект финальной документации

README является точкой входа и ссылается на архитектуру, REST-контракты, права, безопасность,
локальный запуск, интеграцию Naumen, файловый чек-лист и этот аудит. Формулировки во всех документах
разделяют реализованный проектный код и неподтверждённые адаптеры реальной установки.
