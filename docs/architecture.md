...
Статус: актуализировано по итогам этапа 12.
Источник требований: docs/requirements.md.
Реализованы базовый frontend, транспорт, авторизация, локализация, формы, каталоги, создание заявки, список и карточка заявки. Карточка пользователя, редактор SLA и файловый механизм не реализованы.
...
На этом этапе проектируются, но не реализуются: страницы, транспорт, серверные функции, тесты и интеграция с Naumen.
