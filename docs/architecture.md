...
Статус: актуализировано по итогам этапа 10.
Источник требований: docs/requirements.md.
Реализованы базовый frontend, транспорт, авторизация, локализация, формы, каталоги и создание заявки по услуге. Списки и карточка заявки и последующие предметные разделы не реализованы.
