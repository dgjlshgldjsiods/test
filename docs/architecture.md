...
Статус: актуализировано по итогам этапа 7.
Источник требований: docs/requirements.md.
Реализованы базовый frontend, транспорт, авторизация, локализация, список форм и редактор версий. Каталог услуг и последующие предметные разделы не реализованы.
