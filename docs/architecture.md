...
Статус: актуализировано по итогам этапа 8.
Источник требований: docs/requirements.md.
Реализованы базовый frontend, транспорт, авторизация, локализация, формы и административный редактор каталога. Пользовательский каталог и последующие предметные разделы не реализованы.
