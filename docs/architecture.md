...
Статус: актуализировано по итогам этапа 13.
Источник требований: docs/requirements.md.
Реализованы базовый frontend, транспорт, авторизация, локализация, формы, каталоги, заявки и карточка пользователя. Редактор SLA и файловый механизм не реализованы.
