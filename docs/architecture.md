...
Статус: актуализировано по итогам этапа 9.
Источник требований: docs/requirements.md.
Реализованы базовый frontend, транспорт, авторизация, локализация, формы, административный редактор и пользовательский каталог. Создание заявки и последующие предметные разделы не реализованы.
